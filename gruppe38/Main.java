...
public class Main {
	...
	/**
	 * Maximale anzahl legbarer Bomben
	 */
	 ...
	 * @param von Anfang des Bereich
	 * @param bis Ende des Bereich
	 * @return	Zufallszahl von "von" bis "bis"
	 */
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (spiel_start) {
				...
				/**
				 * Befehle fuer das Zeichnen des Spieles
				 * ============================================================
				 */
				...
				// Malt ein weisses Viereck zum uebermalen
