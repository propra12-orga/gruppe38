...
public class Steuerung extends Main {
	...
	/**
	 * Wenn eine Taste gedrueckt wird, werden entsprechende Werte veraendert
	 */
	public static void aktionen() {

		/*
		 * Steuerung, StdDraw wurde bearbeitet in Zeile 1363. KeyListener des
		 * Frames wurde benoetigt. Wurde einer Pfeiltaste oder iwas gedrueckt,
