...
public static void menu(){
  	System.out.println("Zeige Menu");
  		
  		jpanel = new JPanel();
  		jpanel.setName("BOMBERMAN 2012 - Netzwerksteuerung");
  		
  		frame.add(jpanel);
  		
  		JLabel label1 = new JLabel("<html><br>Netzwerk</br></html>");
  		jpanel.add(label1, BorderLayout.PAGE_START);
  		label1.setFont(new Font("Stencil Std", Font.PLAIN, 30));
