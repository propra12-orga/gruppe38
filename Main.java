...
public class Main {
	...
	public static int bombencounter = 0;// z�hlt die anzahl der bomben
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// des Frames wurde ben�tigt.
			// Wurde einer Pfeiltaste oder iwas gedr�ckt, boolean=true,
			...
			/*
			 * wenn Leertaste gedr�ckt wird: 1)gecheckt, ob der bombencounter
			 * gleich 479 ist, wenn ja counter=0; 2)neue Bombe wird im Thread
			 * erstellt. vorher wird gepr�ft auf welchem feld sich der spieler
