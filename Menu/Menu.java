...
public class Menu extends JFrame implements ActionListener {
	...
	public Menu() {
		...
		JLabel label3 = new JLabel(
				"by Patrick Hippler, Daniel Braune, Tom Berwald, Patrick Szewior & Sebastian Holthausen");
		jpanel.add(label3);
		...
		JLabel labelmitte1 = new JLabel(
				"Ziel des Spiel ist es, den Ausgang diagonal gegenï¿½ber des Startpunktes");
		jpanel.add(labelmitte1, BorderLayout.CENTER);
		labelmitte1.setFont(new Font("Arial", Font.PLAIN, 15));

		JLabel labelmitte2 = new JLabel(
				"zu erreichen, indem die zerstï¿½rbaren Mauern mithilfe von Bomben");
		jpanel.add(labelmitte2, BorderLayout.CENTER);
		labelmitte2.setFont(new Font("Arial", Font.PLAIN, 15));

		JLabel labelmitte3 = new JLabel(
				"zerstï¿½rt werden und sich somit ein weg zum Ausgang freigemacht wird.");
		...
		JLabel labelmitte5 = new JLabel(
				"PFEILTASTEN: Hoch, Runter, Rechts, Links  // SPACE: Bombe legen");
